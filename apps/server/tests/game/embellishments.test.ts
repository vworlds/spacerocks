...
import {
  ...
  rgbToU32,
} from '../../src/game/embellishments';
import { registerPlayerSessionComponents } from '../../src/game/playerSessions';
import { registerShootingComponents } from '../../src/game/shooting';
...
function createTestWorld(): World {
  ...
  registerEmbellishmentComponents(
    world as unknown as Parameters<typeof registerEmbellishmentComponents>[0],
  );
  installEmbellishmentSystems(
    world as unknown as Parameters<typeof installEmbellishmentSystems>[0],
  );
  return world;
}
